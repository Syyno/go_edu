...
const (
	...
	UserV1_GetByUserName_FullMethodName = "/user_v1.UserV1/GetByUserName"
...
func (c *userV1Client) GetByUserName(ctx context.Context, in *GetByUserNameRequest, opts ...grpc.CallOption) (*GetResponse, error) {
	out := new(GetResponse)
	err := c.cc.Invoke(ctx, UserV1_GetByUserName_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedUserV1Server) GetByUserName(context.Context, *GetByUserNameRequest) (*GetResponse, error) {
